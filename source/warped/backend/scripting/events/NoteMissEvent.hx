...
final class NoteMissEvent extends CancellableEvent {
	...
	public function new(n:Note, sc:Int, miss:Int, muteV:Bool, healthG:Float, missS:String,missV:Float,gMiss:Bool,gfS:Bool,gfSAnim:String,forceGF:Bool,forceA:Bool,suffix:String,chars:Array<Character>, pID:Int, nT:String, dir:Int, acc:Float)
	{
		super();
